...
#  .......................... The index and find index Method ...............
...
animals = ["cheetah", "cats", "lion", "elephant", "dog", "cat"]
...
users = [["Bob", 25, "Male"], ["Susan", 48, "Female"], ["Larry", 68, "Male"]]
...
steak, veggie = foods.partition { |food| food.include?("Steak") }
